...
if initial_num_cols != final_num_cols:
    print(f"🛑 Warning: Number of columns changed after making unique. Before: {initial_num_cols}, After: {final_num_cols}. This might indicate an issue with how duplicates were handled previously.")
assert not df_renamed.columns.duplicated().any(), "⚠️ Still has duplicate columns after unique renaming!"
print("✅ All columns are now unique.")
...
print(f"✅ Target column '{target_col}' has been log1p transformed.")
...
print(f"\n🔢 Numeric Columns (excluding target and original target scale): {len(numeric_cols)}")
...
print(f"  ✅ Total {len(missing_indicator_cols)} missingness indicator features created.")
...
print(f"\n✅ New features added and lists updated. Total numeric columns now: {len(numeric_cols)}")
...
print("\n🕳️ Top 10 columns with missing values (after feature engineering):")
print(missing_percent.head(10))

print("\n📉 Columns with >50% missing (after feature engineering):")
...
print("\n📊 Top 15 features most correlated with target (after feature engineering):")
print(correlation.head(15))

print("\n🔻 Bottom 10 least correlated (near zero) (after feature engineering):")
...
print(f"\n✅ Keeping {len(features_to_keep_numeric)} numeric features")
print(f"🗑️ Dropping {len(features_to_drop_numeric)} numeric features due to high missing & low correlation:")
print(features_to_drop_numeric)

print("\n🔤 Categorical Columns to keep for processing:")
...
print("✅ Preprocessing complete. Final Feature Matrix Shape:", X_processed.shape)
...
print("\n📊 Starting Hyperparameter Optimization for individual models with Optuna (this may take significant time)...")
...
print(f"✅ XGBoost Optuna Best RMSE: {study_xgb.best_value:.4f}")
...
print(f"✅ CatBoost Optuna Best RMSE: {study_cat.best_value:.4f}")
...
print(f"✅ RandomForest Optuna Best RMSE: {study_rf.best_value:.4f}")
print("RandomForest Best parameters:", study_rf.best_params)


# --- 11. Train Final Individual Models with Optimized Parameters ---
print("\n🎯 Training final individual models with optimized parameters (for ensemble and SHAP)...")
...
print("✅ Final XGBoost model trained with Optuna-tuned parameters.")
...
print("✅ Final CatBoost model trained with Optuna-tuned parameters.")
...
print("✅ Final RandomForest model trained with Optuna-tuned parameters.")


# --- 12. Create and Train Ensemble Model (VotingRegressor) ---
print("\n🎯 Creating and training ensemble model with optimized base models...")
...
print("\n🔍 Generating SHAP values for XGBoost model in the ensemble for explainability...")
...
try:
    ...
    plt.tight_layout()
    plt.show()
    print("✅ SHAP Summary Plot generated for XGBoost.")

except Exception as e:
    print(f"⚠️ Error generating SHAP plots for XGBoost: {e}")
